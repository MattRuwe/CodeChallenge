...
Guid(GuidList.guidVSExtensionPkgString)> _
Public NotInheritable Class VSExtensionPackage
    Inherits Package
...
#Region "Package Members"
    ...
    Protected Overrides Sub Initialize()
        ...
        If Not mcs Is Nothing Then
            ...
            Dim toolwndCommandID As New CommandID(GuidList.guidVSExtensionCmdSet, CInt(PkgCmdIDList.cmdidCodeChallenge))
